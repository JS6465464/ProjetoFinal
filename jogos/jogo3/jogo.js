        ...
        function mostrarMensagem(texto, classeEstilo) {
            ...
            mensagemJogo.className = 'caixa-mensagem ' + classeEstilo;
        }
        ...
        function tratarAcerto(cartaoClicado) {
            ...
            if (tentativasRonda === 1) {
                ...
                mostrarMensagem("ESPETÁCULO! Acertaste à 1ª! ⭐🎉", 'mensagem-sucesso');
            } else {
                estrelasGanhas = 0.5;   // 2ª tentativa = meia estrela
                mostrarMensagem("MUITO BEM! Conseguiste! 🌟🎉", 'mensagem-sucesso');
            }
