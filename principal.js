...
const imagemBemVindo =
    document.querySelector(
        ".titulo-principal img"
    );

if (
    fundoEscolhido === "recursos/fundo3.png" ||
    ...
    imagemBemVindo.src =
        "recursos/bem_vindo_escuro.png";

} else {

    imagemBemVindo.src =
        "recursos/bem_vindo.png";
...
botaoAmigo.addEventListener(
    ...
    function () {
        ...
        popupNomesRegistados.style.display =
            "none";

        popupHistorico.style.display =
            "none";
        ...
        if (popupBrinquedosAberto !== null) {
            ...
            popupBrinquedosAberto.style.display =
                "none";
...
const botaoNomesRegistados =
    document.getElementById(
        "botaoNomesRegistados"
    );

const popupNomesRegistados =
    document.getElementById(
        "popupNomesRegistados"
    );

const fecharNomesRegistados =
    document.getElementById(
        "fecharNomesRegistados"
    );

const listaNomesRegistados =
    document.getElementById(
        "listaNomesRegistados"
    );
...
function registarEscolhaAtual() {
    ...
    const registos =
        lerRegistosUtilizador();

    const posicao =
        encontrarRegistoAtual(
            registos
        );
    ...
    if (posicao !== -1) {
        ...
        registoExistente.nome =
            nome;

        registoExistente.cabeca =
            cabeca;

        registoExistente.amigo =
            amigo;
        ...
        guardarRegistosUtilizador(
            registos
        );

        carregarDadosDoRegisto(
            registoExistente
        );
...
function mostrarNomesRegistados() {
    ...
    if (registos.length === 0) {
        ...
        mensagem.textContent =
            "Ainda não existem nomes registados.";
...
function selecionarNomeRegistado(
    registo
) {
...
botaoNomesRegistados.addEventListener(
    "click",
    function () {
...
fecharNomesRegistados.addEventListener(
    "click",
    function () {
...
function mostrarHistorico() {
    ...
    if (
        ...
        registos[posicao].historico ===
            undefined ||
        registos[posicao].historico.length ===
            0
    ) {
        ...
        mensagem.textContent =
            "Ainda não existem resultados no histórico.";
